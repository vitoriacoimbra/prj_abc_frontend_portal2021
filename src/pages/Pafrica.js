...
export default class Processadas extends React.Component {
  ...
  loadProcessos = async()=>{
    const {data} = await api.get('processos/africa');
 ...
 buscar = async (e) =>{
  ...
  if(!filtro || filtro === '' || filtro === " " || filtro === null){
    ...
    if(!coluna || coluna ==="" || coluna === null){
      ...
      data = await api.get(`/busca/processadas?empresa=1&coluna=${coluna}&busca=${filtro}`);
      data = data.data
    }
            ...
            <div className="row">
              <div className="col-sm-12 header">
                <div className="download">
                  ...
                  <Excel mes={this.state.buscaMes} empresa="africa"/>
