...
loadProcessos = async()=>{
  const {data} = await api.get('editar/africa');
...
pegaMes(valor){
  ...
  buscar = async (e) =>{
    ...
    if(!filtro || filtro === '' || filtro === " " || filtro === null){
      ...
      if(!coluna || coluna ==="" || coluna === null){
        ...
        data = await api.get(`/busca/editar?empresa=1&coluna=${coluna}&busca=${filtro}`);
        data = data.data
      }
  ...
  render() {
    ...
    return (
      ...
      <>
        <Menu pged="active" activeA={true}/>
        <div className="paineldireito">
          <div className="painel container-fluid">
          <div className="row">
              <div className="col-sm-12 header">
                <div className="download">
                  <ExcelEd mes={this.state.buscaMes} empresa="africa"/>
